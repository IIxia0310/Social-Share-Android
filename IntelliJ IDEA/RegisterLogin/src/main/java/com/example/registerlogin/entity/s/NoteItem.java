...
//    }
//
//    public NoteItem(Note note, User user, Long likeSum, int likeIng, Long collectSum, int collectIng, int followIng) {
//        this.note = note;
//        this.user = user;
//        this.likeSum = likeSum;
//        this.likeIng = likeIng;
...
//    }
    ...
    public NoteItem(Note note, User user, Long likeSum, int likeIng) {
        this.note = note;
        this.user = user;
        this.likeSum = likeSum;
        this.likeIng = likeIng;
