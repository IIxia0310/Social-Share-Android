...
import com.example.registerapplication.Adapters.MessageFollowAdapter;
...
public class Message1GView2Follow extends AppCompatActivity {


    private RecyclerView recyclerView;
    private ListTService listTService;
    private List<FollowItem> fanList;
    private MessageFollowAdapter messageFollowAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.message1_gview2_follow);
    ...
    private void initToolbar() {
        Toolbar toolbar = findViewById(R.id.Toolbar_Message1Gview2Follow);
        toolbar.setTitle("新增关注");
    ...
    private void initViews() {
        ...
        // 绑定组件id
        theme = findViewById(R.id.Theme_Message1Gview2Follow);
        if (user!= null) {
        ...
        recyclerView = findViewById(R.id.Message1Gview2Follow_RecyclerView);

        // 初始化 followList
        fanList = new ArrayList<>();
        messageFollowAdapter = new MessageFollowAdapter(fanList, listTService, user.getUserId());
                    ...
                    if (response.isSuccessful()) {
                        ...
                        if (newNotes != null) {
                            ...
                            if (followItemsArray != null &&!followItemsArray.isEmpty()) {
                                ...
                                // 通知适配器数据已更新
                                messageFollowAdapter.notifyDataSetChanged();
                            } else {
                                // 数据为空，清空适配器
                                fanList.clear();
                                messageFollowAdapter.notifyDataSetChanged();
                            ...
                            Log.e("Message1GView2Follow", "响应体为空");
                            // 响应体为空，清空适配器
                            fanList.clear();
                            messageFollowAdapter.notifyDataSetChanged();
                            isLoading = false;
                        ...
                        Log.e("Message1GView2Follow", "请求不成功，状态码: " + response.code());
                    }
                }

                @Override
                public void onFailure(Call<ListTResponse<List<FollowItem>>> call, Throwable t) {
                    Log.e("Message1GView2Follow", "请求失败", t);
                    // 请求失败，清空适配器
                    fanList.clear();
                    messageFollowAdapter.notifyDataSetChanged();
                    isLoading = false;
