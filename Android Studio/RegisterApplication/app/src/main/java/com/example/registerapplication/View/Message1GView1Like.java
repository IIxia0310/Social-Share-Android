 ...
 * 我的评论
 */
public class Message1GView1Like extends AppCompatActivity {


    private static final String TAG = "Message1GView1Like";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.message1_gview1_like);
    ...
    private void initToolbar() {
        Toolbar toolbar = findViewById(R.id.Toolbar_Message1Gview1Like);
        toolbar.setTitle("赞和收藏");
    ...
    private void  initViews(){
        theme = findViewById(R.id.Theme_Message1Gview1Like);
        if (user!= null) {
        ...
        recyclerView = findViewById(R.id.Message1Gview1Like_list);
        // 设置线性布局管理器
        ...
        adapter.setOnSide2CommentItemClickListener(new Side2CommentListItemAdapter.OnSide2CommentClickListener() {
            ...
            public void onOnSide2CommentItemClick(SideCommentItem sideCommentItem) {
                ...
                if (sideCommentItem.getNoteItem().getNote()!=null){
                    ...
                    //点击了定位，打开笔记
                    Intent intent1 = new Intent(Message1GView1Like.this, NoteDetails.class);
                    intent1.putExtra("note_item", sideCommentItem.getNoteItem());
                    startActivity(intent1);


                }else {
                    Toast.makeText(Message1GView1Like.this, "作品已不可见", Toast.LENGTH_SHORT).show();
    ...
    private void initSideComment() {
        ...
        // 发起网络请求
        Call<ListTResponse<List<SideCommentItem>>> call = listTService.mssage1GView1Like(userIng.getUserId());
