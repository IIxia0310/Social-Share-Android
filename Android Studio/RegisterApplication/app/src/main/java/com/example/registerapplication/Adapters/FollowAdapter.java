...
public class FollowAdapter extends RecyclerView.Adapter<FollowAdapter.FollowViewHolder> {
    ...
    public FollowAdapter(List<FollowItem> followList,ListTService listTService, Long userId) {
    ...
    public void onBindViewHolder(@NonNull FollowViewHolder holder, int position) {
        FollowItem followItem = followList.get(position);
        if (followItem != null) {
            ...
            if (user != null) {
                ...
                if (followItem.getFollowIng() == 1) {
                    ...
                    if(followItem.getFollowFanIng()==1){
                        holder.followButton.setText("互关");
                        holder.followButton.setCompoundDrawablesWithIntrinsicBounds(context.getResources().getDrawable(R.drawable.ic_all6), null, null, null);

                    }else {
                        holder.followButton.setText("已关");
                        holder.followButton.setCompoundDrawablesWithIntrinsicBounds(context.getResources().getDrawable(R.drawable.ic_all3), null, null, null);
                    }
                }else {
                    holder.followButton.setText("关注");
                    holder.followButton.setCompoundDrawablesWithIntrinsicBounds(null, null, null, null);
                }
                ...
                holder.followButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (followItem.getFollowIng()==1) {
                            ...
                            // 是否互关
                            if(followItem.getFollowFanIng()==1){
                                holder.followButton.setText("回关");
                                holder.followButton.setCompoundDrawablesWithIntrinsicBounds(null, null, null, null);
    ...
    public class FollowViewHolder extends RecyclerView.ViewHolder {
        ...
        public FollowViewHolder(@NonNull View itemView) {
            ...
            followButton = itemView.findViewById(R.id.me_folloefan_button);
        }
    }
