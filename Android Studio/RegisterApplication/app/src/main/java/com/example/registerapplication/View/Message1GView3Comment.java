 ...
 * 我的评论
 */
public class Message1GView3Comment extends AppCompatActivity {


    private static final String TAG = "Message1GView3Comment";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.message1_gview3_comment);
    ...
    private void initToolbar() {
        Toolbar toolbar = findViewById(R.id.Toolbar_Message1Gview3Commen);
    ...
    private void  initViews(){
        theme = findViewById(R.id.Theme_Message1Gview3Comment);
        if (user!= null) {
        ...
        recyclerView = findViewById(R.id.Message1Gview3Commen_list);
        // 设置线性布局管理器
        ...
        adapter.setOnSide2CommentItemClickListener(new Side2CommentListItemAdapter.OnSide2CommentClickListener() {
            ...
            public void onOnSide2CommentItemClick(SideCommentItem sideCommentItem) {
                ...
                if (sideCommentItem.getNoteItem().getNote()!=null){
                    ...
                    //点击了定位，打开笔记
                    Intent intent1 = new Intent(Message1GView3Comment.this, NoteDetails.class);
                    intent1.putExtra("note_item", sideCommentItem.getNoteItem());
                    startActivity(intent1);


                }else {
                    Toast.makeText(Message1GView3Comment.this, "作品已不可见", Toast.LENGTH_SHORT).show();
    ...
    private void initSideComment() {
        ...
        // 发起网络请求
        Call<ListTResponse<List<SideCommentItem>>> call = listTService.mssage1GView3Comment(userIng.getUserId());
